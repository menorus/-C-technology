...
// 3zadacha.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMy3zadachaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMy3zadachaApp

CMy3zadachaApp::CMy3zadachaApp()
{
...
// Единственный объект CMy3zadachaApp

CMy3zadachaApp theApp;


// Инициализация CMy3zadachaApp

BOOL CMy3zadachaApp::InitInstance()
{
