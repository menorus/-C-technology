...
// zadacha4.2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Czadacha42App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание Czadacha42App

Czadacha42App::Czadacha42App()
{
...
// Единственный объект Czadacha42App

Czadacha42App theApp;


// Инициализация Czadacha42App

BOOL Czadacha42App::InitInstance()
{
