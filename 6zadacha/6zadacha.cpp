...
// 6zadacha.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMy6zadachaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMy6zadachaApp

CMy6zadachaApp::CMy6zadachaApp()
{
...
// Единственный объект CMy6zadachaApp

CMy6zadachaApp theApp;


// Инициализация CMy6zadachaApp

BOOL CMy6zadachaApp::InitInstance()
{
